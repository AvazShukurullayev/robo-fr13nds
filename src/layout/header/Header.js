            ...
            <div className="container">
                <nav className="nav d-flex align-items-center justify-content-between">
                    ...
                    <ul className="nav__list d-flex align-items-center gap-4">
                        <li><a href="#!" className="fs-3 text-decoration-none nav__link">About</a></li>
                        <li><a href="#!" className="fs-3 text-decoration-none nav__link">Contact</a></li>
                        <li><a href="#!" className="fs-3 text-decoration-none nav__link">Support</a></li>
                    </ul>
                </nav>
            </div>
        </header>
